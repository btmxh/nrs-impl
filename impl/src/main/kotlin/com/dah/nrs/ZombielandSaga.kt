...
fun DSLScope.ZombielandSaga() {
    Entry {
        ...
        Entry {
            ...
            title = "Yume wo Te ni, Modoreru Basho mo Nai Hibi wo/Kaze no Tsuyoi Hi wa Kirai ka?" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.5)
            SubIDEntry("1", "Yume wo Te ni, Modoreru Basho mo Nai Hibi wo") {
                title = "Yume wo Te ni, Modoreru Basho mo Nai Hibi wo" // generated by fill_metadata.dart v0.1.0
                Music(5.5)
            }
        }
    }
