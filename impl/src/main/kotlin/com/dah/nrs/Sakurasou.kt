...
fun DSLScope.Sakurasou() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-35015"
            title = "Kimi ga Yume wo Tsuretekita / Pet na Kanojotachi" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.4)
            SubIDEntry("1") {
                title = "Kimi ga Yume wo Tsuretekita" // generated by fill_metadata.dart v0.1.1
                Music(2.25)
            }
        }
    }
