...
fun DSLScope.Cue() {
    Entry {
        ...
        Entry {
            ...
            title = "Start Line/Hajimari no Kanenone ga Narihibiku Sora / AiRBLUE" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.2)

            SubIDEntry("1", "Start Line") {
                title = "スタートライン" // generated by fill_metadata.dart v0.1.0
                Music(7.0)
            }

            SubIDEntry("2", "Hajimari no Kanenone ga Narihibiku Sora") {
                title = "はじまりの鐘の音が鳴り響く空" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AR-33857"
            title = "AiRBLUE" // generated by fill_metadata.dart v0.1.0
