...
fun DSLScope.Kaguya() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-83397"
            title = "Chikatto Chika Chika♡ / Chika Fujiwara (CV. Konomi Kohara)" // generated by fill_metadata.dart v0.1.0
            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1") {
                title = "Chikatto Chika Chika♡" // generated by fill_metadata.dart v0.1.0
                Music(2.5)
        ...
        Entry {
            ...
            title = "KAGUYA ♡ ULTRA BEST" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("11", "Arigatou.") {
                title = "ありがとう。" // generated by fill_metadata.dart v0.1.0
