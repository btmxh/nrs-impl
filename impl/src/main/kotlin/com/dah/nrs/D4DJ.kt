...
fun DSLScope.D4DJ() {
    Entry {
        ...
        Entry {
            ...
            title = "Guruguru DJ TURN!! / Happy Around!" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.75)
            SubIDEntry("3") {
                title = "Guruguru DJ TURN!!" // generated by fill_metadata.dart v0.1.0
                Music(3.5)
            }
        }
        ...
        Entry {
            ...
            title = "D4DJ Special Disc Photon Maiden Ver." // generated by fill_metadata.dart v0.1.0

            ValidatorSuppress("dah-visualless-entry")
            SubIDEntry("2", "Brand New World") {
                title = "Brand New World" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
            }
        }
    }
