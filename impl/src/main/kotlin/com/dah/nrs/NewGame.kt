...
fun DSLScope.NewGame() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-58627"
            title = "Now Loading!!!! / fourfolium" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.7, 0.3)
            SubIDEntry("1") {
                title = "Now Loading!!!!" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
        ...
        Entry {
            id = "M-VGMDB-AL-68225"
            title = "STEP by STEP UP↑↑↑↑ / fourfolium" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.7, 0.3)
            SubIDEntry("1") {
                title = "STEP by STEP UP↑↑↑↑" // generated by fill_metadata.dart v0.1.0
                // mankai step by step
