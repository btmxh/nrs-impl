...
fun DSLScope.Saekano() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-48199"
            title = "Saenai heroine no sodate-kata Character Image Song M♭ / Megumi Kato" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.6, 0.4)

            SubIDEntry("1") {
                title = "M♭" // generated by fill_metadata.dart v0.1.0
                Music(2.0)
