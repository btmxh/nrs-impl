...
fun DSLScope.KokoroConnect() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-35431"
            title = "Kokoro Connect Original Soundtrack 2 Hito Random & Kizu Random Opening Theme Song \"Kimochi Signal\" / Kizu Random Ending Theme Song \"Cry out\"" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.3)

            SubIDEntry("1", "Kimochi Signal") {
                title = "Kimochi Signal" // generated by fill_metadata.dart v0.1.0
                Music(1.5)
            }
        }
