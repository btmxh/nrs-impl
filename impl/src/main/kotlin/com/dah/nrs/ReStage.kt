...
//            NEI(9.0, Emotion.AP)
        ...
        Entry {
            id = "M-VGMDB-AL-78536"
            title = "Startin' My Re:STAGE!! / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.2, 0.6)

            SubIDEntry("2") {
                title = "Startin' My Re:STAGE!!" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-78534"
            title = "Remembers! / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.4)

            SubIDEntry("1") {
                title = "リメンバーズ!" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.0)
            ...
            SubIDEntry("2", "Kimi ni Okuru Angel Yell") {
                title = "君に贈るAngel Yell" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-78575"
            title = "Natsu no Yakusoku / KiRaRe" // generated by fill_metadata.dart v0.1.1

            // 367days background lmfao
            Visual(VisualKind.AlbumArt, 0.25, 0.6)

            SubIDEntry("1") {
                title = "Natsu no Yakusoku" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(1.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-78532"
            title = "Akogare Future Sign / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.6)

            SubIDEntry("1") {
                title = "憧れFuture Sign" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.0)
            }
        ...
        Entry {
            id = "M-VGMDB-AL-78530"
            title = "KiRaRhythm / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1", "Do it!! PARTY!!") {
                title = "Do it!! PARTY!!" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-78516"
            title = "SENSEI Sensation / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.6)
            SubIDEntry("1") {
                title = "宣誓センセーション" // generated by fill_metadata.dart v0.1.1
                // [plasmagunstepgica]
                ReStepMusic(3.0)
        ...
        Entry {
            id = "M-VGMDB-AL-78764"
            title = "367Days / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1") {
                title = "367Days" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-84229"
            title = "HAPPY TYPHOON / KiRaRe" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.4)
            SubIDEntry("1") {
                title = "ハッピータイフーン" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(0.8)
            }

            SubIDEntry("2", "Stereo Life") {
                title = "ステレオライフ" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-86622"
            title = "Re:STAGE! DREAM DAYS♪ SONG SERIES 1: Don't think, smile!!" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.2)
            SubIDEntry("1", "Don't think, smile!!") {
                title = "Don't think, smile!!" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(2.5)
            }

            SubIDEntry("2", "Akogare Future Sign (Piano Strings Arrange)") {
                title = "Akogare Future Sign (Piano Strings Arrange)" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(2.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-89363"
            title = "Re:STAGE! DREAM DAYS♪ SONG SERIES 5 INSERT SONG MINI ALBUM: DRe:AMER KiRaRe ver." // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("1", "Kirameki Future") {
                title = "Kirameki Future" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("2", "OvertuRe:") {
                title = "OvertuRe:" // generated by fill_metadata.dart v0.1.1
                // meme lyrics xddd
                // I can't rely on one
                // 一つじゃ頼りない
        ...
        Entry {
            id = "M-VGMDB-AR-30829"
            title = "KiRaRe" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-89364"
            title = "Re:STAGE! DREAM DAYS♪ SONG SERIES 6 INSERT SONG MINI ALBUM: DRe:AMER ortensia ver." // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("3", "Yes, We Are!!!") {
                title = "Yes, We Are!!!" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-78520"
            title = "Purple Rays / ortensia" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.35, 0.55)

            SubIDEntry("1") {
                title = "Purple Rays" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.0)
            }

            SubIDEntry("2", "Dear My Friend") {
                title = "Dear マイフレンド" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(4.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-78339"
            title = "*Heart Confusion* / ortensia" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.65)
            SubIDEntry("1") {
                title = "*Heart Confusion*" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(1.0)
            }

            SubIDEntry("2", "crave") {
                title = "crave" // generated by fill_metadata.dart v0.1.1
                // gigachad keeno:
        ...
        Entry {
            id = "M-VGMDB-AL-82983"
            title = "Pullulate / ortensia" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("5", "Ano ne") {
                title = "Ano ne" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(2.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-82369"
            title = "Q.E.D. / Stellamaris" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.5)

            SubIDEntry("1", "InFiction") {
                title = "InFiction" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(4.5)
            }

            SubIDEntry("8", "DESERT BLACK FLOWER") {
                title = "DESERT BLACK FLOWER" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(7.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-78515"
            title = "Raise Your Fist / Tetrarkhia" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.4)

            SubIDEntry("1", "Canaria") {
                title = "カナリア" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(6.0)
            }
        }
        ...
        Entry {
            ...
            title = "私たち、四季を遊ぶんです!!" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "Re:STAGE! CONCEPT MINI ALBUM: Chain of Dream" // generated by fill_metadata.dart v0.1.1
            // aka method appreciation album

            Visual(VisualKind.AlbumArt, 0.5, 0.2)

            SubIDEntry("1", "Bridge to Dream") {
                title = "Bridge to Dream" // generated by fill_metadata.dart v0.1.1
                // method, la method
            ...
            SubIDEntry("2", "Re:Rays") {
                title = "Re:Rays" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(5.0)
            }

            SubIDEntry("3", "Tomorrow Melodies") {
                title = "Tomorrow Melodies" // generated by fill_metadata.dart v0.1.1
                // do chinh la method
            ...
            SubIDEntry("4", "Pins&Needles") {
                title = "Pins&Needles" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(4.5)
            }

            SubIDEntry("5", "We Remember") {
                title = "We Remember" // generated by fill_metadata.dart v0.1.1
                // ngau loi vai ra
        ...
        Entry {
            ...
            title = "Sin City / Kasumi Honjou, Ruka Ichijou & Mikuru Bandou" // generated by fill_metadata.dart v0.1.1
            // aka sussin city

            Visual(VisualKind.AlbumArt, 0.3, 0.6)

            SubIDEntry("1") {
                title = "Sin City" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.5)
            }
        }
        ...
        Entry {
            ...
            title = "Chiguhagu Melody / Mana Shikimiya, Sayu Tsukisaka & Sango Misaki" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("1") {
                title = "Chiguhagu Melody" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(2.0)
            }
        }
        ...
        Entry {
            ...
            title = "Unison Monologue / Tetrarkhia" // generated by fill_metadata.dart v0.1.1
            // aka the 330 bpm song but actually an alt-165 bpm one

            Visual(VisualKind.AlbumArt, 0.35, 0.6)
            SubIDEntry("1") {
                title = "ユニゾンモノローグ" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(3.0)
            }
        }
        ...
        Entry {
            ...
            title = "Ginga no Shizuku / TROIS ANGES" // generated by fill_metadata.dart v0.1.1
            // le gingachad seiyuu

            Visual(VisualKind.AlbumArt, 0.3, 0.6)
            SubIDEntry("1") {
                title = "Ginga no Shizuku" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(1.5)
            }
        }
        ...
        Entry {
            ...
            title = "Clematis / Stellamaris" // generated by fill_metadata.dart v0.1.1
            // catjam tho
            ...
            SubIDEntry("1") {
                title = "Clematis" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(6.5)
            }
        }
        ...
        Entry {
            ...
            title = "Ideal/Idol / KiRaRe" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("1") {
                title = "Ideal/Idol" // generated by fill_metadata.dart v0.1.1
                ReStepMusic(1.5)
            }
        }
