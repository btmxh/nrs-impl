...
fun DSLScope.Atelier() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-45361"
            title = "Escha & Logy no Atelier ~Tasogare no Sora no Renkinjutsushi~ Original Soundtrack the Animation" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.25)
            SubIDEntry("1", "Asuiro") {
                title = "アスイロ" // generated by fill_metadata.dart v0.1.1
