...
fun DSLScope.YLIA() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-49046"
            title = "Shigatsu wa Kimi no Uso ORIGINAL SONG & SOUNDTRACK" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.5)
            SubIDEntry("1", "Kimi wa Wasurerareru no") {
                title = "Kimi wa Wasurerareru no" // generated by fill_metadata.dart v0.1.1
                Music(3.0)
                AEI(5.0, Emotion.CU)
            }

            SubIDEntry("18", "Yuujin A-kun wo Watashi no Bansousha ni Ninmeishimasu") {
                title = "Yuujin A-kun wo Watashi no Bansousha ni Ninmeishimasu" // generated by fill_metadata.dart v0.1.1
                Music(3.0)
                AEI(5.0, Emotion.CU)
            }
        }
    ...
    Entry {
        id = "M-VGMDB-AR-9069"
        title = "Masaru Yokoyama" // generated by fill_metadata.dart v0.1.1
