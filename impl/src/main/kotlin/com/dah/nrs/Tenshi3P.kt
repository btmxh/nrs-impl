...
fun DSLScope.Tenshi3P() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-68189"
            title = "Habataki no Birthday / Baby's breath" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.3)
            SubIDEntry("1") {
                title = "Habataki no Birthday" // generated by fill_metadata.dart v0.1.0
                Music(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-69018"
            title = "Kusabi / Baby's breath" // generated by fill_metadata.dart v0.1.0
            Visual(VisualKind.AlbumArt, 0.5, 0.3)
            SubIDEntry("1") {
                title = "Kusabi" // generated by fill_metadata.dart v0.1.0
                Music(3.0)
            }
        }
    }
