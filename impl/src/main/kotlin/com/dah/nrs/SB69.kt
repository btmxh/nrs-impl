...
fun DSLScope.SB69() {
    ...
    Entry {
        ...
        Entry {
            ...
            title = "How To Fly / Cyan & Howan" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.45, 0.3)
            SubIDEntry("1") {
                title = "How To Fly" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-94913"
            title = "My pace!! / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.3, 0.7)

            SubIDEntry("1") {
                title = "My pace!!" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-51276"
            title = "Seishun wa Non-Stop! / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.6)

            SubIDEntry("1") {
                title = "Seishun wa Non-Stop!" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(2.5)
            ...
            SubIDEntry("2", "Close to you") {
                title = "Close to you" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(4.0)
        ...
        Entry {
            id = "M-VGMDB-AL-51278"
            title = "Tabimichi Yoiyoi Yume Hanabi / Tsurezurenaru Ayatsuri Mugenan" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.45, 0.5)

            SubIDEntry("1") {
                title = "Tabimichi Yoiyoi Yume Hanabi" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(3.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-51706"
            title = "Meikyuu DESTINY/Ryuusei Dreamline / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.55, 0.4)

            SubIDEntry("1", "Meikyuu DESTINY") {
                title = "Meikyuu DESTINY" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(5.0)
            }

            SubIDEntry("2", "Ryuusei Dreamline") {
                title = "Ryuusei Dreamline" // generated by fill_metadata.dart v0.1.1
                // kekekekekekek
                FesALiveMusic(2.25)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-61217"
            title = "Heart wo Rock!! / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.45, 0.4)

            SubIDEntry("1") {
                title = "Heart wo Rock!!" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(7.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-61940"
            title = "Schlehit Melodie/Danzai no Solitude / BUD VIRGIN LOGIC" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.4)

            SubIDEntry("1", "Schlehit Melodie") {
                title = "Schlehit Melodie" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(4.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-61981"
            title = "My Resolution ~Mirai e no Kizuna~ / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1") {
                title = "My Resolution ～未来への絆～" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(5.0)
            }

            SubIDEntry("3", "Close to you (Cyan ver.)") {
                title = "Close to you (詩杏 ver.)" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(3.5)
        ...
        Entry {
            id = "M-VGMDB-AL-59914"
            title = "Do Re Mi Fa PARTY / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.35, 0.5)

            SubIDEntry("1") {
                title = "ドレミファPARTY" // generated by fill_metadata.dart v0.1.1
                // xd
                FesALiveMusic(2.0)
                Meme(0.1, 2)
            }
        ...
        Entry {
            id = "M-VGMDB-AL-93440"
            title = "Hiromenes/Kimi no Rhapsody / Mashumairesh!!" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.3)

            SubIDEntry("1", "Hiromenes") {
                title = "Hiromenes" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(6.0)
            }

            SubIDEntry("2", "Kimi no Rhapsody") {
                title = "Kimi no Rhapsody" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("3", "Masshiro Start Line") {
                title = "Masshiro Start Line" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-93441"
            title = "Yell and Response / Mashumairesh!!" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.3)

            SubIDEntry("1") {
                title = "エールアンドレスポンス" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(2.0)
            }
        }
        ...
        Entry {
            ...
            title = "Do Re Mi Fa STARS!!/Hoshizora Light Story" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.3)

            SubIDEntry("1", "Do Re Mi Fa STARS!!") {
                title = "Do Re Mi Fa STARS!!" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("2", "Hoshizora Light Story") {
                title = "Hoshizora Light Story" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(3.5)
            }
        }
        ...
        Entry {
            ...
            title = "TV Anime \"SHOW BY ROCK!! STARS!!\" Sounyuuka Mini Album Vol.1" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.1, 0.2)

            SubIDEntry("3", "Do! It! Happy Daibouken!") {
                title = "Do! It! Happy Daibouken!" // generated by fill_metadata.dart v0.1.1
                // do it party reference lmfao
                FesALiveMusic(6.5)
            }

            SubIDEntry("6", "Kyukyukyun♡Heart Shaker") {
                title = "Kyukyukyun♡Heart Shaker" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "TV Anime \"SHOW BY ROCK!! STARS!!\" Sounyuuka Mini Album Vol.2" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.1, 0.2)

            SubIDEntry("5", "EMPIRE DOMINATOR") {
                title = "EMPIRE DOMINATOR" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(2.5)
            }

            SubIDEntry("8", "Anokanatarium") {
                title = "Anokanatarium" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-61982"
            title = "Hanate! Dododon! / Criticrista" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.4)

            SubIDEntry("1") {
                title = "Hanate! Dododon!" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(5.0)
            }
        }
        ...
        Entry {
            ...
            title = "Taikakusen wo Tsunaideyo / Uwasanopetals" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.3)

            SubIDEntry("1") {
                title = "Taikakusen wo Tsunaideyo" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(6.5)
            }
        }
        ...
        Entry {
            ...
            title = "Good Day by Day / Cyan (cv. Eri Inagawa), A (cv. Saori Hayami), Ailane (cv. Ruriko Noguchi), Shibarin (cv. Marika Kohno)" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("1") {
                title = "グッデイバイデイ" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(3.5)
            }
        ...
        Entry {
            ...
            title = "Mirai Wanted / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.5)

            SubIDEntry("1") {
                title = "Mirai Wanted" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(5.0)
            }
        }
        ...
        Entry {
            ...
            title = "Bokura no Neiro / Plasmagica" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.5)

            SubIDEntry("1") {
                title = "Bokura no Neiro" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "Mot Mot Mot / Criticrista" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.45)

            SubIDEntry("1") {
                title = "Mot Mot Mot" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(6.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-86315"
            title = "P SHOW BY ROCK!! CD" // generated by fill_metadata.dart v0.1.1
            Visual(VisualKind.AlbumArt, 0.6, 0.5)

            SubIDEntry("3", "Nyumber One! Zettai Saikyou!") {
                title = "Nyumber One! Zettai Saikyou!" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(7.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-76155"
            title = "Loop Shiteru/Asuiro Koi Moyou / Criticrista" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.3, 0.3)

            SubIDEntry("1", "Loop Shiteru") {
                title = "ループしてる" // generated by fill_metadata.dart v0.1.1
                // :tf:
                FesALiveMusic(2.5)
            }

            SubIDEntry("2", "Asuiro Koi Moyou") {
                title = "あすいろ恋模様" // generated by fill_metadata.dart v0.1.1
                // absolute catjammer
        ...
        Entry {
            id = "M-VGMDB-AL-95313"
            title = "How Are You? / Criticrista" // generated by fill_metadata.dart v0.1.1
            Visual(VisualKind.AlbumArt, 0.3, 0.3)

            SubIDEntry("1") {
                title = "はうあーゆー？" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-95314"
            title = "Happy Happy Jump / Criticrista" // generated by fill_metadata.dart v0.1.1
            Visual(VisualKind.AlbumArt, 0.3, 0.3)

            SubIDEntry("1") {
                title = "Happy Happy Jump" // generated by fill_metadata.dart v0.1.1
                FesALiveMusic(5.0)
            }
        }
