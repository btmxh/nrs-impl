...
fun DSLScope.OsuGame() {
    Entry {
        id = "M-VGMDB-AR-12225"
        title = "xi" // generated by fill_metadata.dart v0.1.0

        Entry {
            id = "M-VGMDB-AL-34269"
            title = "Parousia" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.15, 0.4)

            // the third ayumu-era theme song
            SubIDEntry("7", "Ascension to Heaven") {
                title = "Ascension to Heaven" // generated by fill_metadata.dart v0.1.0
                Music(3.0)
            }

            SubIDEntry("12", "FREEDOM DiVE↓") {
                title = "FREEDOM DiVE↓" // generated by fill_metadata.dart v0.1.0
