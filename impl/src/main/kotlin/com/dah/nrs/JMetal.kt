...
fun DSLScope.JMetal() {
    Entry {
        id = "M-VGMDB-AR-8482"
        title = "Foreground Eclipse" // generated by fill_metadata.dart v0.1.0

        Entry {
            id = "M-VGMDB-AL-97601"
            title = "Truths, Ironies, The Secret Lyrics" // generated by fill_metadata.dart v0.1.0
        ...
        Entry {
            id = "M-VGMDB-AL-43320"
            title = "Stories That Last Through The Sleepless Nights" // generated by fill_metadata.dart v0.1.0

            Contains("M-VGMDB-AL-97601-1")
            Visual(VisualKind.AlbumArt, 0.25, 0.4)

            SubIDEntry("4") {
                title = "Wandering, Never Wondering (There Exists A Shade)" // generated by fill_metadata.dart v0.1.0
                Music(2.5)
            }

            SubIDEntry("7") {
                title = "From Under Cover (Caught Up In A Love Song)" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
            }

            // the second ayumu-era theme song
            SubIDEntry("8") {
                title = "Storytellers" // generated by fill_metadata.dart v0.1.0
                Music(5.0)
            }
        }
    }
