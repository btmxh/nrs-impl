...
fun DSLScope.Tanmoshi() {
    Entry {
        ...
        Entry {
            ...
            title = "Kodou / Nanakagura" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.3)
            SubIDEntry("1") {
                title = "Kodou" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
            }
        }
        ...
        Entry {
            ...
            title = "Koko de Ikiteru / mary & jon-YAKITORY" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.3)
            SubIDEntry("1") {
                title = "Koko de Ikiteru" // generated by fill_metadata.dart v0.1.0
                Music(4.0)
            }
        }
    }
