...
fun DSLScope.Irodori() {
    ...
    Entry {
        id = "M-VGMDB-AR-9553"
        title = "cosMo@bousouP" // generated by fill_metadata.dart v0.1.1
    ...
    Entry {
        id = "M-VGMDB-AL-91187"
        title = "CHUNITHM ALL JUSTICE COLLECTION ep.I" // generated by fill_metadata.dart v0.1.1

        Visual(VisualKind.AlbumArt, 0.05, 0.5)

        SubIDEntry("35", "Endmark ni kibou to namida o soete") {
            title = "エンドマークに希望と涙を添えて" // generated by fill_metadata.dart v0.1.1
            Music(3.5)
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-93299"
            title = "GO!GO! Chunithm♥Endmark / IRODORIMIDORI" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.35)

            SubIDEntry("2") {
                title = "エンドマークに希望と涙を添えて ～イロドリミドリアレンジ～" // generated by fill_metadata.dart v0.1.1
