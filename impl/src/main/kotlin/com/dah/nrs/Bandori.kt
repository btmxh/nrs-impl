...
fun DSLScope.Bandori() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-60358"
            title = "STAR BEAT! ~Hoshi no Kodou~ / Poppin'Party" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.1)

            SubIDEntry("1") {
                title = "STAR BEAT! ~Hoshi no Kodou~" // generated by fill_metadata.dart v0.1.1
                Music(4.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-63624"
            title = "Tokimeki Experience! / Poppin'Party" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.2)

            SubIDEntry("1") {
                title = "Tokimeki Experience!" // generated by fill_metadata.dart v0.1.1
                Music(1.5)
            }

            SubIDEntry("2", "1000 kai Urunda Sora") {
                title = "1000 kai Urunda Sora" // generated by fill_metadata.dart v0.1.1
                Music(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-81504"
            title = "KIZUNA MUSIC♪ / Poppin'Party" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.15, 0.4)

            SubIDEntry("1") {
                title = "KIZUNA MUSIC♪" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "Live Beyond!! / Poppin'Party" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.6, 0.15)

            SubIDEntry("5", "Koko kara Saki wa Uta ni Naranai") {
                title = "Koko kara Saki wa Uta ni Naranai" // generated by fill_metadata.dart v0.1.1
                Music(4.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-74133"
            title = "CiRCLiNG / Poppin'Party" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.35, 0.15)

            SubIDEntry("2", "Light Delight") {
                title = "Light Delight" // generated by fill_metadata.dart v0.1.1
                // naite naite
                // daite daite
                Music(6.0)
            }
        ...
        Entry {
            id = "M-VGMDB-AL-95118"
            title = "Initial/Yume wo Uchinuku Shunkan ni! / Poppin'Party [Special Edition]" // generated by fill_metadata.dart v0.1.1
            ...
            SubIDEntry("2", "Yume wo Uchinuku Shunkan ni!") {
                title = "Yume wo Uchinuku Shunkan ni!" // generated by fill_metadata.dart v0.1.1
                Music(3.0)
                // iykyk
                Meme(0.05, 10)
            }
        ...
        Entry {
            id = "M-VGMDB-AR-27992"
            title = "Poppin'Party" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-85172"
            title = "FIRE BIRD / Roselia" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.2, 0.6)

            SubIDEntry("1") {
                title = "FIRE BIRD" // generated by fill_metadata.dart v0.1.1
                Music(3.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AR-27993"
            title = "Roselia" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AR-31328"
            title = "Pastel*Palettes" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AR-31329"
            title = "Hello, Happy World!" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            id = "M-VGMDB-AL-82743"
            title = "Y.O.L.O!!!!! / Afterglow" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.25, 0.15)

            SubIDEntry("1") {
                title = "Y.O.L.O!!!!!" // generated by fill_metadata.dart v0.1.1
                Music(3.5)
        ...
        Entry {
            id = "M-VGMDB-AR-31326"
            title = "Afterglow" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "BanG Dream! Girls Band Party! Cover collection vol.5" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.5, 0.1)

            SubIDEntry("1", "Cherry Bomb") {
                title = "Cherry Bomb" // generated by fill_metadata.dart v0.1.1
                Music(3.0)
        ...
        Entry {
            ...
            title = "BanG Dream! Girls Band Party! Cover collection vol.6" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.45, 0.1)

            SubIDEntry("8", "Silhouette") {
                title = "Silhouette" // generated by fill_metadata.dart v0.1.1
                Music(5.0)
        ...
        Entry {
            id = "M-VGMDB-AR-31336"
            title = "RAISE A SUILEN" // generated by fill_metadata.dart v0.1.1
        ...
        Entry {
            ...
            title = "Sacred world / RAISE A SUILEN" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.2, 0.3)
            SubIDEntry("1") {
                title = "Sacred world" // generated by fill_metadata.dart v0.1.1
                Music(4.0)
            }
        }
    ...
    Entry {
        id = "M-VGMDB-AR-31509"
        title = "SILENT SIREN" // generated by fill_metadata.dart v0.1.1
    ...
    Entry {
        id = "M-VGMDB-AR-25291"
        title = "KANA-BOON" // generated by fill_metadata.dart v0.1.1

        Entry {
            id = "M-VGMDB-AL-50723"
            title = "Silhouette / KANA-BOON" // generated by fill_metadata.dart v0.1.1
