...
fun DSLScope.Gotoubun() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-82284"
            title = "Gotoubun no Kimochi / Nakano-ke no Itsutsugo" // generated by fill_metadata.dart v0.1.0
            Visual(VisualKind.AlbumArt, 0.5, 0.5)

            SubIDEntry("1") {
                title = "Gotoubun no Kimochi" // generated by fill_metadata.dart v0.1.0
                Music(3.0)
            }
        }
    }
