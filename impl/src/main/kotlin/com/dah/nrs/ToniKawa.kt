...
fun DSLScope.ToniKawa() {
    ...
    Entry {
        ...
        Entry {
            ...
            title = "Koi no Uta (feat. Tsukasa Yuzaki) / Yunomi" // generated by fill_metadata.dart v0.1.1

            Visual(VisualKind.AlbumArt, 0.4, 0.6)
            SubIDEntry("1", "Koi no Uta (feat. Yuzaki Tsukasa)") {
                title = "Koi no Uta (feat. Yuzaki Tsukasa)" // generated by fill_metadata.dart v0.1.1
                Music(4.0)
            }
        }
    }
