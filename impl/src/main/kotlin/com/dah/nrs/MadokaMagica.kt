...
fun DSLScope.MadokaMagica() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-30302"
            title = "Puella Magi Madoka Magica Special CD 1 Drama CD 'Memories of you'" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.35, 0.6)
            SubIDEntry("2", "Mata Ashita") {
                title = "Mata Ashita" // generated by fill_metadata.dart v0.1.0
                Music(2.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-24725"
            title = "Puella Magi Madoka Magica Special CD 2 Original Soundtrack I" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.35, 0.6)
            SubIDEntry("4", "Credens justitiam") {
                title = "Believing in Justice" // generated by fill_metadata.dart v0.1.0
                Music(2.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-39170"
            title = "Puella Magi Madoka Magica Special CD 5 Drama CD 'Farewell Story'" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.35, 0.6)
            SubIDEntry("2", "and I'm home") {
                title = "and I'm home" // generated by fill_metadata.dart v0.1.0
                Music(1.5)
            }
        }
        ...
        Entry {
            ...
            title = "TV Anime \"Magia Record: Mahou Shoujo Madoka☆Magica Gaiden 2nd SEASON -Kakusei Zenya-\" Theme Song Collection" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1", "Careless") {
                title = "ケアレス" // generated by fill_metadata.dart v0.1.0
                Music(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-95029"
            title = "Gomakashi / TrySail" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.5, 0.4)

            SubIDEntry("1") {
                title = "Gomakashi" // generated by fill_metadata.dart v0.1.0
                Music(6.5)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-91985"
            title = "Utsuroi / TrySail" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.45, 0.4)

            SubIDEntry("1") {
                title = "Utsuroi" // generated by fill_metadata.dart v0.1.0
                // the game
                // browiec's Wisdom
                // Misunderstanding
