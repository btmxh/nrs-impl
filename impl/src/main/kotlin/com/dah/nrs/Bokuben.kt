...
fun DSLScope.Bokuben() {
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-85537"
            title = "Seishun Seminar/Never Give It Up!! / Study" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.7)

            SubIDEntry("1") {
                title = "Seishun Seminar" // generated by fill_metadata.dart v0.1.0
                Music(2.5)
        ...
        Entry {
            id = "M-VGMDB-AL-88884"
            title = "Can now, Can now / Study" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.7)

            SubIDEntry("1") {
                title = "Can now, Can now" // generated by fill_metadata.dart v0.1.0
                Music(2.5)
