...
fun DSLScope.SoraYori() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AL-73544"
            title = "Koko kara, Koko kara / Mari Tamaki (CV: Inori Minase), Shirase Kobuchizawa (CV: Kana Hanazawa), Hinata Miyake (CV: Yuka Iguchi), Yuzuki Shiraishi (CV: Saori Hayami)" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.3, 0.5)
            SubIDEntry("1") {
                title = "Koko kara, Koko kara" // generated by fill_metadata.dart v0.1.0
                Music(5.0)
            ...
            SubIDEntry("2", "One Step") {
                title = "One Step" // generated by fill_metadata.dart v0.1.0
                Music(3.0)
