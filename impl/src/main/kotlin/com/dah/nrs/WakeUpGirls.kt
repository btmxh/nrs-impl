...
fun DSLScope.WakeUpGirls() {
    ...
    Entry {
        ...
        Entry {
            id = "M-VGMDB-AR-15137"
            title = "Wake Up, Girls!" // generated by fill_metadata.dart v0.1.0
        ...
        Entry {
            id = "M-VGMDB-AL-46042"
            title = "Tachiagare! / Wake Up, Girls!" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.6)

            SubIDEntry("1") {
                title = "Tachiagare!" // generated by fill_metadata.dart v0.1.0
                Music(6.0)
            }
        }
        ...
        Entry {
            id = "M-VGMDB-AL-42945"
            title = "7 Girls War / Wake Up, Girls!" // generated by fill_metadata.dart v0.1.0

            Visual(VisualKind.AlbumArt, 0.4, 0.6)

            SubIDEntry("1") {
                title = "7 Girls War" // generated by fill_metadata.dart v0.1.0
                Music(3.5)
            }
        }
    ...
    Entry {
        ...
        title = "One In A Billion / Wake Up, May'n! [Limited Edition]" // generated by fill_metadata.dart v0.1.0

        Visual(VisualKind.AlbumArt, 0.1, 0.2)

        SubIDEntry("1") {
            title = "One In A Billion" // generated by fill_metadata.dart v0.1.0
